@component('admin.content' , ['title' => 'ایجاد تخفیف ویژه محصول'])
    @slot('breadcrumb')
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" action="{{ route('admin.amazing_sales.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="percentage" class="form-control" placeholder="درصد تخفیف را وارد کنید" value="{{ old('percentage') }}" required>
                        </div>
