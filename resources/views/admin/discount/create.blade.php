@component('admin.content' , ['title' => 'ایجاد کد تخفیف'])
    @slot('breadcrumb')
                ...
                <form class="form-horizontal" action="{{ route('admin.discounts.store') }}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" name="expired_at" class="form-control"  placeholder="مهلت استفاده را وارد کنید" value="{{ old('expired_at') }}">
                        </div>
                    </div>
                    <!-- /.card-body -->
