<?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr class="text-center">
        ...
        <td><?php echo e($sub_category->parent($sub_category->parent_id)); ?></td>
        <td class="d-flex">
            ...
            <div class="display-inline-block mr-3">
             ...
             <?php if($level < 2): ?>
                <a href="<?php echo e(route('admin.categories.create')); ?>?parent_id=<?php echo e($sub_category->id); ?>" class="btn btn-sm btn-primary mr-3">ثبت زیر دسته</a>
             <?php endif; ?>
        </td>
    </tr>
...
<?php /**PATH /home/sadegh/Desktop/project/my_digistyle/resources/views/admin/layouts/categories-group.blade.php ENDPATH**/ ?>