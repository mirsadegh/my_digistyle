<?php $__env->startSection('content'); ?>
            <div class="row">
                ...
                <div id="content" class="col-xs-12">
                    ...
                    <!-- Banner End-->
                    <!-- محصولات Tab Start -->
                        <?php echo $__env->make('Frontend.layouts.tabStart', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <!-- محصولات Tab Start -->
                    <!-- Banner Start -->
                    <div class="marketshop-banner">
                        <div class="row">
...
<?php echo $__env->make('Frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Home\Desktop\project\digistyle\resources\views/Frontend/index.blade.php ENDPATH**/ ?>