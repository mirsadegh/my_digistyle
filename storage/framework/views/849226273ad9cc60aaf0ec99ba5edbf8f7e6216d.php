<?php $__env->startComponent('admin.content' , ['title' => 'ویرایش  محصولات ویژه']); ?>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" action="<?php echo e(route('admin.amazing_sales.update' , $amazingSale->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group">
                            ...
                            <select name="product_id" class="form-control">
                                ...
                                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 <option value="<?php echo e($product->id); ?>"<?php echo e($product->id == $amazingSale->product_id ? 'selected' : ''); ?>><?php echo e($product->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="percent" class="col-sm-2 control-label">میزان تخفیف (درصد)</label>
                            <input type="number" name="percentage" class="form-control" placeholder="درصد تخفیف را وارد کنید" value="<?php echo e(old('percentage',$amazingSale->percentage)); ?>" required>
                        </div>
...
<?php /**PATH /home/sadegh/Desktop/project/my_digistyle/resources/views/admin/amazingSale/edit.blade.php ENDPATH**/ ?>